...
1. **Validación de Archivos**  
   1.1 El sistema debe validar el formato (extensión), el tipo MIME y el tamaño máximo del archivo antes de iniciar la subida al servidor (Ver HU-090).   
...
3. **Almacenamiento y Seguridad**  
   ...
   3.2. Los archivos físicos deben almacenarse en un directorio protegido, y el acceso debe ser mediante endpoints autenticados (Ver HU-091).
