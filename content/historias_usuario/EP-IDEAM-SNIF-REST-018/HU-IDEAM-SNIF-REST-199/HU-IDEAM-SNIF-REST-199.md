...
**Disparador del registro de auditoría**\
...
✔️ La auditoría es obligatoria para toda modificación geométrica confirmada.

❌ No se permite eliminar ni editar registros de auditoría.

✔️ La auditoría es exclusivamente de consulta institucional (IDEAM).

✔️ Los registros deben permitir trazabilidad completa entre versiones.

✔️ Esta HU depende del recalculo exitoso de áreas y traslapes.

## DIAGRAMA DE FLUJO DEL PROCESO

![IMAGEN FLUJO DE ACTIVIDADES](/content/historias_usuario/EP-IDEAM-SNIF-REST-018/assets/actividades-hu-ideam-snif-rest-199.png)